const boletos = require('./src/index') // Importando o módulo e atribuindo numa constante
...
let validacao = boletos.boleto(boletocodigo)

// Retorna os dados do boleto em um objeto
let dados = boletos.validarBoleto(boletocodigo)
